...
- (void)viewDidLoad {
    ...
    self.coverImage = [UIImage imageNamed:@"facecoverrect"];
    ...
    coverImageView.image = [UIImage imageNamed:@"facecoverrect"];
    ...
    // 设置超时时间
    [[FaceSDKManager sharedInstance] setConditionTimeout:1000000];
